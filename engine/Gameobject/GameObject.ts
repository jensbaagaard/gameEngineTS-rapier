...
export class GameObject {
  ...
  public getInput(input: string[]): boolean {
    ...
    return input.every((key) => !!this.game.pressedKeys[key]);
  }
  ...
  public getKeyDown(input: string[]): boolean {
    return input.every((key) => !!this.game.keysDownThisFrame[key]);
  }
  ...
  public getKeyUp(input: string[]): boolean {
    return input.every((key) => !!this.game.keysUpThisFrame[key]);
  }
